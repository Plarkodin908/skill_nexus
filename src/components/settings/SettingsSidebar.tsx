...
const SettingsSidebar = ({ activeTab, setActiveTab }: SettingsSidebarProps) => {
  ...
  return (
    <div className="input">
      ...
      <button 
        className="value" 
        data-state={activeTab === 'privacy' ? 'active' : undefined}
      ...
      <button 
        className="value" 
        data-state={activeTab === 'appearance' ? 'active' : undefined}
      ...
      <button 
        className="value" 
        data-state={activeTab === 'language' ? 'active' : undefined}
      ...
      <button 
        className="value" 
        data-state={activeTab === 'notifications' ? 'active' : undefined}
      ...
      <button 
        className="value" 
        data-state={activeTab === 'security' ? 'active' : undefined}
        onClick={() => handleTabChange('security')}
      >
        <Shield className="text-[#7D8590]" size={15} />
        Security
      </button>
      
      <button 
        className="value" 
        data-state={activeTab === 'skills' ? 'active' : undefined}
      ...
      <button 
        className="value" 
        data-state={activeTab === 'data' ? 'active' : undefined}
