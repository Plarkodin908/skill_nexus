...
const SettingsSidebar = ({
  ...
  return <div className="input">
      <button data-state={activeTab === 'account' ? 'active' : undefined} onClick={() => handleTabChange('account')} className="value px-[5px]">
      ...
      <button data-state={activeTab === 'privacy' ? 'active' : undefined} onClick={() => handleTabChange('privacy')} className="value px-[5px]">
      ...
      <button data-state={activeTab === 'appearance' ? 'active' : undefined} onClick={() => handleTabChange('appearance')} className="value px-[5px]">
      ...
      <button data-state={activeTab === 'language' ? 'active' : undefined} onClick={() => handleTabChange('language')} className="value px-[5px]">
      ...
      <button data-state={activeTab === 'notifications' ? 'active' : undefined} onClick={() => handleTabChange('notifications')} className="value px-[5px]">
      ...
      <button data-state={activeTab === 'skills' ? 'active' : undefined} onClick={() => handleTabChange('skills')} className="value px-[7px]">
        <List className="text-[#7D8590]" size={15} />
        Skills
      </button>
      
      <button data-state={activeTab === 'data' ? 'active' : undefined} onClick={() => handleTabChange('data')} className="value px-[5px]">
        <Database className="text-[#7D8590]" size={15} />
        Data
      </button>
    </div>;
};
