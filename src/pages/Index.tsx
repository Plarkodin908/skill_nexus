              ...
              <div className="w-full md:w-1/2 space-y-6">
                ...
                <div className="flex flex-wrap gap-4">
                  {user ? <Link to="/dashboard">
                      ...
                      <Button className="bg-primary-purple hover:bg-primary-purple/90 text-white font-medium px-6 py-2.5 text-base text-justify bg-purple-800 hover:bg-purple-700">
