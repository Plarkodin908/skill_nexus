...
const Hero = () => {
  ...
  return <section className="container mx-auto pt-24 md:pt-32 pb-16 px-4 relative">
      <div className="flex flex-col md:flex-row items-center justify-between gap-10">
        <ScrollReveal direction="left" className="w-full md:w-1/2 space-y-6">
          ...
          <div className="flex flex-wrap gap-4 pt-4">
            {user ? <>
                <Link to="/profile">
                  <Button className="bg-gray-700 hover:bg-gray-800 text-white px-4 py-2 md:px-6 md:py-6 text-sm md:text-base">
