...
const SignUp = () => {
  ...
  return <div className="min-h-screen flex flex-col items-center justify-center px-4 py-12 bg-slate-900">
      ...
      <div className="mb-8 text-center">
        <img src="/lovable-uploads/609db0c7-2e29-405b-ad44-bee4b401e14e.png" alt="SKILL NEXUS Logo" className="h-20 w-auto mx-auto" />
