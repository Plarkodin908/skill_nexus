        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            <div className="hidden md:flex items-center space-x-6">
              <Link to="/marketplace" className="text-white hover:text-gray-400 transition-colors">Marketplace</Link>
              <Link to="/tutorials" className="text-white hover:text-gray-400 transition-colors">Tutorials</Link>
              <Link to="/community" className="text-white hover:text-gray-400 transition-colors">Community</Link>
            </div>
          </div>
          
          <div className="flex items-center space-x-3">
            <form onSubmit={handleSearch} className="hidden md:flex relative">
              <input type="text" placeholder="Search..." className="bg-white/5 backdrop-blur-sm border border-white/10 text-white px-4 py-2 rounded-full focus:outline-none focus:border-gray-400 w-[200px]" />
        ...
        {isMobileMenuOpen && <div className="md:hidden py-4 border-t border-white/10 mt-3 animate-fade-in">
            <div className="flex flex-col space-y-4">
              ...
              <form onSubmit={handleSearch} className="relative mt-2">
                <input type="text" placeholder="Search..." className="w-full bg-white/5 backdrop-blur-sm border border-white/10 text-white px-4 py-2 rounded-full focus:outline-none focus:border-gray-400" />
                <button type="submit" className="absolute right-3 top-1/2 -translate-y-1/2">
                  <Search className="h-5 w-5 text-white/50" />
                </button>
              </form>
