  ...
  return (
    <div className="skill-exchange-theme min-h-screen">
      ...
      <main className="mt-20">
        {/* Hero Banner Section */}
        <section className="bg-dark-purple py-12 px-4 rounded-3xl mt-10">
          <div className="container mx-auto">
            <div className="flex flex-col md:flex-row gap-8 items-center">
              <div className="w-full md:w-1/2 space-y-6">
                <h1 className="text-3xl md:text-5xl font-bold text-white leading-tight">
                  Learn, Share, Grow with <span className="text-mint">Skill Nexus</span>
                </h1>
              ...
              <div className="w-full md:w-1/2">
                <div className="relative bg-gray-300/20 rounded-xl p-2 shadow-lg">
                  <img 
                    src="/lovable-uploads/fc36b4c8-69b6-42c9-a569-c1ecaf82ed35.png" 
                    alt="Skill Nexus Hero" 
