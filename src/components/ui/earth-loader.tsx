...
const EarthLoader = ({ className, text = "Connecting..." }: EarthLoaderProps) => {
  return (
    <div className={cn("earth flex flex-col items-center", className)}>
      ...
      <p className="text-white text-xl font-sans mt-1">{text}</p>
    </div>
  );
};
