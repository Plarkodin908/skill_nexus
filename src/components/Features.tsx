      ...
      <div className="container mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            ...
            >
              <div className="bg-gray-800/30 backdrop-blur-sm p-6 md:p-8 rounded-xl border border-gray-700/30 h-full transition-all duration-300 hover:transform hover:scale-105 hover:bg-gray-800/50 group">
