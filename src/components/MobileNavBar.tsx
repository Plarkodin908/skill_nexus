...
const MobileNavBar = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 lg:hidden">
      {isOpen && (
        <div className="bg-forest-light border-t border-mint/10 p-4 rounded-t-2xl shadow-lg animate-slide-in-up">
          ...
          <div className="grid grid-cols-2 gap-2">
            <Link 
              to="/"
              className="flex items-center gap-2 p-3 rounded-lg bg-forest hover:bg-mint/10 text-white"
              onClick={toggleMenu}
            >
            ...
            <Link 
              to="/pricing"
              className="flex items-center gap-2 p-3 rounded-lg bg-forest hover:bg-mint/10 text-white col-span-2"
              onClick={toggleMenu}
            >
      ...
      <div className="flex justify-around items-center bg-forest-light border-t border-mint/10 p-2 px-4">
        ...
        <Button 
          className="rounded-full bg-mint text-forest p-3 -mt-5 shadow-lg hover:bg-mint/90"
          onClick={toggleMenu}
        >
