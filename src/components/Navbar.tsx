...
const Navbar = () => {
  ...
  return <nav className="fixed top-0 left-0 w-full bg-dark-purple/80 backdrop-blur-lg z-50 shadow-md">
      <div className="container mx-auto px-4 py-3">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            <form onSubmit={handleSearch} className="hidden md:flex relative">
              <input type="text" placeholder="Search..." className="bg-forest/60 border border-primary-purple/30 text-white px-4 py-2 rounded-lg focus:outline-none focus:border-primary-purple w-[200px]" />
            ...
            {user ? <>
                <button onClick={handleNotificationsClick} className="p-2 rounded-full hover:bg-forest/60 transition-colors relative">
            ...
            <button onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)} className="p-2 rounded-full hover:bg-forest/60 transition-colors md:hidden">
        ...
        {/* Mobile Menu */}
        {isMobileMenuOpen && <div className="md:hidden py-4 border-t border-primary-purple/20 mt-3">
            <div className="flex flex-col space-y-4">
              ...
              <form onSubmit={handleSearch} className="relative mt-2">
                <input type="text" placeholder="Search..." className="w-full bg-forest/60 border border-primary-purple/30 text-white px-4 py-2 rounded-lg focus:outline-none focus:border-primary-purple" />
                <button type="submit" className="absolute right-3 top-1/2 -translate-y-1/2">
                  <Search className="h-5 w-5 text-white/50" />
                </button>
              </form>
